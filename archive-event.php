...
// ACF DATA.
$event_archive_title = get_field( 'event_archive_title', 'option' );
$archive_description = get_field( 'event_archive_description', 'option' );
	...
	<div class="archive-hero">
		<div class="container">
			<div class="archive-hero__heading">
				<?php if( $event_archive_title ) : ?>
					<h1><?php echo esc_html( $event_archive_title ); ?></h1>
				<?php endif; ?>
				<div class="right">
